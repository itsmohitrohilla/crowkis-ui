  ...
  },
  {
    ...
    items: [
      [
        ...
        "Community is free forever — full engine, no license, no sign-up. Enterprise is flat per cluster per year, priced in one conversation: email license@crowkis.io and we'll get on a call. No usage metering, no per-seat math.",
      ],
      [
      ...
      [
        ...
        "Email license@crowkis.io. For Enterprise we'll run Crowkis Replay on a sample of your own traffic during the call, so you see your real savings before spending anything.",
      ],
    ],
  },
  {
      ...
      <section className="section max-w-4xl py-10 md:py-14">
        ...
        <Reveal>
          <div className="card-block flex flex-col items-start justify-between gap-4 p-6 sm:flex-row sm:items-center">
            ...
            <a
              href="mailto:license@crowkis.io?subject=Crowkis%20question"
