...
# ============ CONFIGURATION ============
DATA_DIR = Path(os.environ.get("UI_UX_PRO_MAX_DATA_DIR", Path(__file__).parent.parent / "data"))
MAX_RESULTS = 3
...
CSV_CONFIG = {
    "style": {
        ...
        "output_cols": ["Style Category", "Type", "Keywords", "Primary Colors", "Effects & Animation", "Best For", "Light Mode вњ“", "Dark Mode вњ“", "Performance", "Accessibility", "Framework Compatibility", "Complexity", "AI Prompt Keywords", "CSS/Technical Keywords", "Implementation Checklist", "Design System Variables"]
    },
    "color": {
        "file": "colors.csv",
